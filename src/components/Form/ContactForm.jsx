...
function ContactForm({className}) {
  ...
  return (
    <div className={`bg-white relative z-20 rounded-3xl ${className}`}>
      <div className="p-4 md:p-6 lg:p-8">
        <form onSubmit={handleSubmit} className="">
          <div className='space-y-4'>
            {/* Name Input */}
            <div>
              <label htmlFor="name" className="block font-medium text-sm lg:text-base text-dark  leading-none py-2">
                Введите имя
              </label>
              <input
                id="name"
            ...
            {/* Phone Input */}
            <div>
              <label htmlFor="phone" className="blockfont-medium text-sm lg:text-base text-dark  leading-none py-2">
                Ваш телефон*
              </label>
              <input
                id="phone"
            ...
            {/* Comment */}
            <div>
              <label htmlFor="comment" className="block font-medium text-sm lg:text-base text-dark  leading-none py-2">
