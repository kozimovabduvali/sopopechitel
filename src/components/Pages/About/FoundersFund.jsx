        ...
        <div className="flex flex-col md:flex-row md:items-end gap-x-6 gap-y-4">
          ...
          <div className="flex-1">
            ...
            <p className="font-medium text-gray text-sm lg:text-base leading-[100%] mt-4 md:mt-5">
              ...
              Задачи:— организация и контроль выполнения благотворительных программ в Фонде;— настройка и оптимизация бизнес-процессов;— контроль целевого использования имущества и денежных средств фонда в соответствии с уставом;— взаимодействие с партнерами, благотворителями, наставниками и пр.
            </p>
          </div>
        </div>
        {/* 2 */}
