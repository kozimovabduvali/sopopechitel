  ...
  return (
    <div>
      <div>
        ...
        <h2 className="font-semibold text-xl md:text-[2rem] lg:text-[2.5rem]  leading-none mt-6 md:mt-8 lg:mt-10">
      ...
      <div className='max-w-212 md:ml-auto mt-10 md:mt-15 lg:mt-18 space-y-10'>
        ...
        <div className="flex flex-col md:flex-row md:items-end gap-x-6 gap-y-4">
          ...
          <div className="flex-1">
            <h4 className="font-medium text-xl md:text-2xl lg:text-3xl  leading-none">
              Кристина Григорьян
            </h4>

            <p className="font-medium text-gray text-sm lg:text-base  leading-none mt-4 md:mt-5">
