  ...
  return (
    <>
      <div className='flex flex-col md:flex-row gap-y-6'>
        <h3 className='font-extrabold  leading-none text-xl '>Модель работы</h3>
        <p className='md:text-2xl lg:text-[32px]  leading-none max-w-212 md:ml-auto'>
        ...
        {cardData.map((card, idx) => (
          <div key={idx} className='border border-dark/20 rounded-3xl lg:rounded-4xl p-4 lg:p-10'>
            ...
            <div className="mt-10 md:mt-18 lg:mt-28">
              ...
              <p className="font-medium text-gray text-sm lg:text-base  leading-none mt-4 md:mt-6">
                {card.text}
              </p>
            </div>
          </div>
