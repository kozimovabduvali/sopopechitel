  ...
  return (
    <>
      <div className='flex flex-col lg:flex-row gap-8'>
        <h3 className='font-extrabold md:text-xl leading-[100%]'>Кому помогаем</h3>
        <div className='md:max-w-142 lg:max-w-212 md:ml-auto'>
          ...
          <div className='grid md:grid-cols-2 gap-5 mt-10 md:mt-15 lg:mt-18'>
            <div className='space-y-6'>
              <h5 className='font-semibold text-base lg:text-xl leading-[100%]'>Почему это важно?</h5>
              <p className='font-medium text-sm lg:text-base leading-[100%]'>Подростковый возраст — ключевой момент, когда формируются основы будущего. Без поддержки этим детям трудно понять себя, поверить в свои силы и научиться принимать важные решения</p>
            </div>
            <div className='space-y-6'>
              <h5 className='font-semibold text-base lg:text-xl leading-[100%]'>Почему это важно?</h5>
              <p className='font-medium text-sm lg:text-base leading-[100%]'>
