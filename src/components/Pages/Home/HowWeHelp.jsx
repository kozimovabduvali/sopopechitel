    ...
    <>
      <div>
        <div className="flex items-center justify-between gap-5">
          ...
          <motion.button
            className="border border-dark rounded-xl hidden md:inline-flex items-center transition duration-200 hover:bg-dark hover:text-white gap-3 h-9 px-5"
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-x-5 gap-y-10 md:gap-y-15 mt-6 md:mt-8 lg:mt-10">
          <div className="max-w-175 w-full">
            <h2 className="max-w-190 font-semibold text-xl md:text-[2rem] lg:text-[2.5rem] leading-[100%]">
          ...
          <div className="lg:max-w-130.5 w-full rounded-[20px] md:rounded-2xl lg:rounded-4xl overflow-hidden bg-gradient-to-b from-[#D8FDFF] to-[#EDF2FE]">
            <img className="mx-auto h-36 md:h-56.5" src={ImageShape || "/placeholder.svg"} alt="shape" />
          </div>
        </div>
      </div>

      {/* Radius Circles with Animation */}
      <div
        ref={ref}
